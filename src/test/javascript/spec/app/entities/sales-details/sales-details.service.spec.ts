...
describe('Service Tests', () => {
    ...
    describe('SalesDetails Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(SalesDetailsService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/sales-details';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return SalesDetails', () => {

                let entity: SalesDetails;
                service.find(123).subscribe((_entity: SalesDetails) => {
                    entity = _entity;
                });
