...
describe('Service Tests', () => {
    ...
    describe('LeftoverDetails Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(LeftoverDetailsService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/leftover-details';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return LeftoverDetails', () => {

                let entity: LeftoverDetails;
                service.find(123).subscribe((_entity: LeftoverDetails) => {
                    entity = _entity;
                });
